...
\restrict UwRU76uqQ2M2S3fmltuTx6KA0KXr2Zx839zvXyddw7Ck3diTPb4QmBLgqdkOK9l
...
COPY public.product_generals (prod_gen_id, prod_name, updated_at, created_at, preorder_policy_id, enterprise_store_id, description, img, category_id) FROM stdin;
1	Thịt heo	2026-02-22 16:26:32.522787	2026-02-22 16:26:32.522761	\N	\N	\N	\N	\N
\.
...
--
-- Name: product_generals product_generals_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_generals
    ADD CONSTRAINT product_generals_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.categories(category_id) NOT VALID;
...
\unrestrict UwRU76uqQ2M2S3fmltuTx6KA0KXr2Zx839zvXyddw7Ck3diTPb4QmBLgqdkOK9l
